...
write.csv(df, "analysis/EPT Supp Table 1.csv")
...
write.csv(df, "analysis/EPT Supp Table 2.csv")
...
write.csv(df, "analysis/EPT Supp Table 3.csv")
...
write.csv(df, "analysis/EPT Supp Table 4.csv")
